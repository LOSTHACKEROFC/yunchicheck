...
const creditPackages: CreditPackage[] = [
  {
    ...
    icon: Zap,
    popular: false,
    features: ["100 Card Checks", "All Gateways", "Basic Support"],
  },
  {
    name: "Professional",
    credits: 500,
    ...
    popular: true,
    savings: "10%",
    features: ["500 Card Checks", "All Gateways", "Priority Support", "Priority Queue"],
  },
  {
    name: "Enterprise",
    credits: 1000,
    ...
    popular: false,
    savings: "20%",
    features: ["1000 Card Checks", "All Gateways", "VIP Support", "Priority Queue"],
  },
  {
    name: "Bulk",
    credits: 2500,
    ...
    popular: false,
    savings: "28%",
    features: ["2500 Card Checks", "All Gateways", "VIP Support", "Priority Queue"],
  },
];
