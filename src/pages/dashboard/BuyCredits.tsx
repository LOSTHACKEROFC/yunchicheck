...
const creditPackages: CreditPackage[] = [
  {
    ...
    icon: Medal,
    popular: false,
    features: ["600 Card Checks", "All Gateways", "Basic Support"],
  },
  {
    name: "Gold",
    credits: 2600,
    ...
    popular: true,
    savings: "8%",
    features: ["2,600 Card Checks", "All Gateways", "Priority Support", "Priority Queue"],
  },
  {
    name: "Diamond",
    credits: 4200,
    ...
    popular: false,
    savings: "14%",
    features: ["4,200 Card Checks", "All Gateways", "VIP Support", "Priority Queue"],
  },
  {
    name: "Elite",
    credits: 7200,
    ...
    popular: false,
    savings: "17%",
    features: ["7,200 Card Checks", "All Gateways", "Dedicated Support", "Priority Queue"],
  },
];
