  ...
  const plans = [
    {
      ...
      checksCount: "600",
      features: [
        { text: "600 Credits", included: true },
        { text: "600 Card Checks", included: true },
    ...
    },
    {
      ...
      savings: "8%",
      features: [
        { text: "2,600 Credits", included: true },
        { text: "2,600 Card Checks", included: true },
        { text: t.allGateways || "All Gateways", included: true },
    ...
    },
    {
      ...
      savings: "14%",
      features: [
        { text: "4,200 Credits", included: true },
        { text: "4,200 Card Checks", included: true },
        { text: t.allGateways || "All Gateways", included: true },
    ...
    },
    {
      ...
      savings: "17%",
      features: [
        { text: "7,200 Credits", included: true },
        { text: "7,200 Card Checks", included: true },
        { text: t.allGateways || "All Gateways", included: true },
